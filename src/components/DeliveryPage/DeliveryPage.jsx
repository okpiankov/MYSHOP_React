  ...
  return (
    <div className={styles.deliveryWrap}>
      <div className={styles.contentBox}>
        ...
        <p>
          Доставка товаров осуществляется из г. Нижний Новгород. Вы можете выбрать доставку другой транспортной
          компанией, оформив заказ через менеджера по телефону.
        </p>
      ...
      <div className={styles.contentBox}>
        <h2>Самовывоз</h2>
        <p>
          Забронируйте нужный товар. После оформления заказа и подтверждения оператором наличия данного товара приедьте,
          оплатите и заберите заказ. Срок бронирования товара в магазине составляет до 3-х дней с момента подтверждения
          заказа.<br></br>
          Самовывоз осуществляется по адресу:<br></br>
          603024 г. Нижний Новгород, улица Тургенева, д. 30. График работы пн. – вс. с 10:00 до 19:00
        </p>
      </div>
    </div>
  );
